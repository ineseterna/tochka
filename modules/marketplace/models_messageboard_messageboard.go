...
type MessageboardThread struct {
	...
	SenderIsAdmin         bool
	SenderIsStaff         bool
	SenderIsGoldAccount   bool
	SenderIsSilverAccount bool
	SenderIsBronzeAccount bool
	SenderIsFreeAccount   bool
	SenderIsSeller        bool
	SenderIsTrustedSeller bool
	...
	database.Exec(`
		CREATE VIEW v_messageboard_threads AS (
			SELECT 
				...
				u1.is_gold_account as sender_is_gold_account, 
				u1.is_silver_account as sender_is_silver_account, 
				u1.is_bronze_account as sender_is_bronze_account, 
				u1.is_free_account as sender_is_free_account,
				u1.is_seller as sender_is_seller,
				u1.is_trusted_seller as sender_is_trusted_seller				
			FROM v_threads
			...
			ORDER BY 
				u1.is_admin DESC, 
				u1.is_staff DESC, 
				u1.is_gold_account DESC, 
				u1.is_silver_account DESC, 
				u1.is_bronze_account DESC,

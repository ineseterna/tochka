...
func (c *Context) ViewShowDeposit(w web.ResponseWriter, r *web.Request) {
	c.Deposits = FindDepositsByUserUuid(c.ViewUser.Uuid)
...
func (c *Context) ViewShowDepositAddPOST(w web.ResponseWriter, r *web.Request) {
	...
	_, err = CreateDeposit(c.ViewUser.Uuid, currency, amount, crypto, cryptoAmount, currencyRate, address)
	if err != nil {
		c.Error = err.Error()
		c.ViewShowDepositAddGET(w, r)
		return
